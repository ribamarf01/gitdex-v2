...
const ThemeSwitcher = () => {
  ...
  return <div className="absolute right-8 border-2 p-1 rounded-xl dark:text-white dark:border-white border-gray-900 hover:bg-gray-900 hover:text-white hover:dark:bg-white hover:dark:text-black transition-all duration-200 cursor-pointer">
    { theme === 'dark' ?
